...
<!-- title -->
    <h1 class="text-5xl font-['Verdana'] text-center font-bold">Favourites</h1><br>
    <hr>
    ...
    <table>
        ...
        include('conn.php');
            ...
            // get favourite info from favourite table
            $sql = mysqli_query($con, "SELECT * FROM favourite WHERE Email = '$Email'");
